                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" method="post" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('cat_img') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" name="cat_img" id="cat_img" accept="image/x-png,image/gif,image/jpeg" placeholder="{{ __('Select Category image') }} ..." value="" required autofocus>
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <form role="form" id="form-edit-category" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('category_name') ? ' has-danger' : '' }}">
                                <input class="form-control" name="category_name" id="cat_name" placeholder="{{ __('Category name') }} ..." type="text">
                                @if ($errors->has('category_name'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('category_name') }}</strong>
                                </span>
