            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @foreach ($category_main->children as $index => $category)
                            @if($category->active == 1 || $category->active == 0)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="row">
                                            ...
                                            @endif
                                            <button class="btn btn-icon btn-1 btn-sm btn-warning" type="button" id="edit" data-toggle="modal" data-target="#modal-edit-category" data-toggle="tooltip" data-placement="top" title="{{ __('Edit category') }} {{ $category->name }}" data-id="<?= $category->id ?>" data-name="<?= $category->name ?>" data-status="<?= $category->active ?>">
                                            ...
                                            @if(count($category_main->children)>1)
                                            ...
                                            <!-- DOWN -->
                                            @if ($index+1!=count($category_main->children))
                                            <a href="{{ route('items.reorder',['up'=>$category_main->children[$index+1]->id]) }}" class="btn btn-icon btn-1 btn-sm btn-success">
