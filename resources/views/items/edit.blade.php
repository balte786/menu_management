                        ...
                        <form method="post" action="{{ route('items.update', $item) }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="item_status">Item Status</label>
                                        <select class="form-control" name="itemAvailable" id="itemAvailable">

                                            <option value="1" <?php if ($item->available == 1) {
                                                                    echo 'selected';
                                                                } ?>>Active</option>
                                            <option value="0" <?php if ($item->available == 0) {
                                                                    echo 'selected';
                                                                } ?>>InActive</option>

                                        </select>
                                        @if ($errors->has('itemAvailable'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('itemAvailable') }}</strong>
                                        </span>
                                        @endif
                                    </div>
