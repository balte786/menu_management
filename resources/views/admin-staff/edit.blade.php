                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ URL::to('/admin-staff/'.$user_data['restaurant_id']) }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ URL::to('/change-admin-staff. $id') }}" autocomplete="off">
                        @csrf
