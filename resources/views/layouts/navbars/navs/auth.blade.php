...
<nav class="navbar navbar-top navbar-expand-md  navbar-dark" id="navbar-main">
  <div class="container-fluid">
    ...
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Restaurants</a>
    @else
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Brands</a>
    @endif
    ...
    <ul class="navbar-nav align-items-center d-none d-md-flex">
      ...
      <a href="{{ $urlToVendor }}" target="_blank" class="nav-link" role="button">
        ...
        @else
        <span class="nav-link-inner--text bold">Brand</span>
        @endif
      </a>
      @endif
      <!-- End owner and staf -->
