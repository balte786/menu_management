                    ...
                    <div class="pl-lg-4">
                        <form method="post" action="{{ route('admin.restaurants.store') }}" autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                @else
                                <label class="form-control-label" for="name">{{ __('Brand Name') }}</label>
                                <input type="text" name="name" id="name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Brand Name here') }} ..." value="" required autofocus>
                                @endif
                                @if ($errors->has('name'))
