                            ...
                            <div class="col-sm col-md col-lg col-lg" id="modalItemDetailsPart">
                                ...
                                <div class="quantity-area">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!--<input type="number" min="1" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="quantity" id="quantity" class="form-control form-control-alternative" placeholder="1" value="1" required autofocus>-->
                                    </div>
